    ...
    render() {
        ...
        return (
            <div>
                ...
                <Row type={'flex'} justify={'space-around'} style={{borderBottom: '1px solid #ddd', paddingBottom: 30}}>
                    <Col span={24} style={{display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 20}}>
                        <img src={logo} style={{height: 130, width: 130, backgroundColor: 'white', borderRadius: 5}}/>
                    </Col>
                    <Col span={24} style={{flexDirection: 'column', display: 'flex', alignItems: 'center'}}>
                ...
                <Row  type={'flex'} justify={'center'} >
                    <a href={`${API_URL}/api/downloadAndroid/${android_download}`}><Button icon={'android-o'} type={'primary'} style={{backgroundColor: '#A4C639', border: '1px solid #A4C639'}} >Download</Button></a>
                    <Button icon={'apple-o'} disabled>Download</Button>
                </Row>
            </div>
        )
    }
